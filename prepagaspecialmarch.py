...
if os.path.exists("\\\\wpnserver\\Data5\\374000-374499\\374072 Acquire Mailing\\Mailing\\AGA DATABASE\\Special AGA March.xlsx"):
    # Open the AGA excel doc
    wb = openpyxl.load_workbook(
        '\\\\wpnserver\\Data5\\374000-374499\\374072 Acquire Mailing\\Mailing\\AGA DATABASE\\Special AGA March.xlsx')
    ...
    for row in range(2, sheet.max_row + 1):
        # Add data to dictionary
        # Change the key to str
        data.append(str(sheet['I' + str(row)].value))
